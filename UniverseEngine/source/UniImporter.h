...
namespace uni::import {
  ...
  public:
    ...
    virtual std::shared_ptr<uni::assets::UniAsset> Import(std::shared_ptr<uni::assets::UniAsset> asset, bool force = false) = 0;
    virtual std::shared_ptr<uni::assets::UniAsset> LoadAsset(json data) = 0;
  ...
  public:
    ...
    std::shared_ptr<uni::assets::UniAsset> Import(std::shared_ptr<uni::assets::UniAsset> asset, bool force = false) override;
    std::shared_ptr<uni::assets::UniAsset> LoadAsset(json data) override;
  };
